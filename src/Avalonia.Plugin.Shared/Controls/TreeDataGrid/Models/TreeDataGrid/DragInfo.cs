...
namespace Avalonia.Controls.Models.TreeDataGrid
{
    ...
    {
        /// <summary>
        /// Defines the data format for TreeDataGrid drag/drop operations.
        /// </summary>
        public static readonly DataFormat DataFormat = DataFormat.CreateStringApplicationFormat("TreeDataGridDragInfo");
