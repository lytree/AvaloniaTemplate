...
{
    private PageBase _selectedItem;

    public AvaloniaList<PageBase> NavigationItems { get; }

    public PageBase SelectedItem
    {
        get => _selectedItem;
        set
        {
    ...
    {
        NavigationItems = new AvaloniaList<PageBase>
            {
                new() {
                    Title = "Home",
